# hermes-cloud-server — Architecture for AI Coding Agents
...
curl -fsSL https://raw.githubusercontent.com/hitechcloud-vietnam/cloud-hermes-management/main/install.sh | bash
